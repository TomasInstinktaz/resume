package com.instinktaz.resume.configuration;
...
import com.instinktaz.resume.filter.ResumeFilter;
import com.instinktaz.resume.listener.ApplicationListener;
...
public class ResumeWebApplicationInitializer implements WebApplicationInitializer {
	...
	private WebApplicationContext createWebApplicationContext(ServletContext container) {
		...
		ctx.scan("com.instinktaz.resume.configuration");
